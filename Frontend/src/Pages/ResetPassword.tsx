...
import { Sparkles, Lock, AlertCircle, ArrowRight, Loader2, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-1">Choose a strong, secure password for your account</p>
        </div>
